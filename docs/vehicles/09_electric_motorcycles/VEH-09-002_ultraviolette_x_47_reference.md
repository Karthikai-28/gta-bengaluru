# VEH-09-002 — Ultraviolette X-47 Reference
...
| Category | Electric Performance Motorcycles |
| Vehicle ID | `VEH-09-002` |
| Reference name | Ultraviolette X-47 Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 1981 mm |
| Overall width | 761 mm |
| Overall height | 1088 mm |
| Wheelbase | 1340 mm |
| Ground clearance | 152 mm |
| Kerb / operating mass | 175 kg |
| Nominal payload | 43 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 413 mm |
| Nominal turning radius | 2.3 m |
| Target drag coefficient / equivalent | 0.42 |
...
| Peak power target | 27 kW |
| Peak torque target | 89 Nm |
| Driven wheels / propulsion | rear wheel electric |
...
| Acceleration rating | 77/100 — High |
| Braking rating | 88/100 — Very High |
| Mobility score | 67/100 — High |
| Stability score | 60/100 — Good |
...
- **Architecture:** USD fork, monoshock.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 110/70-17 / 150/60-17 |
| Brakes | dual-channel ABS + regen |
...
- **Handling score:** **86/100 (Very High)**.
