# VEH-01-016 — Premium Carbon Road Bike
...
| Category | Pedal Cycles |
| Vehicle ID | `VEH-01-016` |
| Reference name | Premium Carbon Road Bike |
| Vehicle archetype | Two-wheel diamond/step-through frame |
...
| Parameter | Target |
|---|---:|
| Overall length | 1847 mm |
| Overall width | 632 mm |
| Overall height | 1073 mm |
| Wheelbase | 1104 mm |
| Ground clearance | 148 mm |
| Kerb / operating mass | 15 kg |
| Nominal payload | 120 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 408 mm |
| Nominal turning radius | 1.9 m |
...
| Displacement | N/A / human-powered |
| Peak power target | 0 kW |
| Peak torque target | 9 Nm |
| Driven wheels / propulsion | human chain drive |
| Transmission | single/multi-speed derailleur |
| Fuel/battery capacity envelope | N/A |
| Driving range envelope | Rider dependent |
...
| Braking rating | 87/100 — Very High |
...
Welded aluminium/steel frame; fork and wheel assemblies are independently damageable.

### Rigidity target

- **Global structural integrity score:** **20/100 (Low)**.
...
- **Architecture:** Telescopic/rigid bicycle fork; rear rigid or suspension depending variant.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 700C / 26–29 in |
| Brakes | mechanical/hydraulic bicycle brakes |
...
- **Handling score:** **85/100 (Very High)**.
...
|---|---|
| Whole-vehicle health | 240 HP simulation baseline |
...
|---|---:|
| Acceleration | 15/100 |
| Top-speed class | 9/100 |
| Braking | 87/100 |
| Handling | 85/100 |
| Stability | 59/100 |
| Mobility | 52/100 |
| Off-road | 35/100 |
| Structural integrity | 20/100 |
