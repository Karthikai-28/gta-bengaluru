# VEH-01-015 — Yulu-Style Shared E-Bike
...
| Vehicle ID | `VEH-01-015` |
| Reference name | Yulu-Style Shared E-Bike |
...
| Overall height | 1081 mm |
| Wheelbase | 1100 mm |
| Ground clearance | 143 mm |
| Kerb / operating mass | 23 kg |
| Nominal payload | 120 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 411 mm |
...
| Peak torque target | 51 Nm |
| Driven wheels / propulsion | rear hub / mid-drive electric |
| Transmission | single-speed or geared |
...
- **Global structural integrity score:** **24/100 (Low)**.
...
- **Architecture:** Telescopic bicycle fork; optional rear suspension.
...
|---|---|
| Whole-vehicle health | 288 HP simulation baseline |
