# VEH-61-003 — Prototype Performance EV
...
| Category | Mission Only Vehicles |
| Vehicle ID | `VEH-61-003` |
| Reference name | Prototype Performance EV |
| Vehicle archetype | SUV / crossover |
...
| Parameter | Target |
|---|---:|
| Overall length | 5219 mm |
| Overall width | 2105 mm |
| Overall height | 1956 mm |
| Wheelbase | 3110 mm |
| Ground clearance | 232 mm |
| Kerb / operating mass | 4235 kg |
| Nominal payload | 1058 kg |
...
| Peak power target | 253 kW |
| Peak torque target | 709 Nm |
| Driven wheels / propulsion | AWD/4WD |
| Transmission | 8AT |
...
| Acceleration rating | 35/100 — Moderate |
| Braking rating | 56/100 — Good |
| Mobility score | 63/100 — Good |
| Stability score | 96/100 — Extreme |
| Off-road capability | 65/100 — High |
...
- **Architecture:** reinforced independent/solid-axle suspension.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | run-flat reinforced 275/55 R20 |
| Brakes | heavy-duty ventilated disc ABS |
