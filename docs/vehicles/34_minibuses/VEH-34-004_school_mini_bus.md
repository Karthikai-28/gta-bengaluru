...
| Category | Tempo Traveller and Mini Buses |
| Vehicle ID | `VEH-34-004` |
| Reference name | School Mini Bus |
...
| Parameter | Target |
|---|---:|
| Overall length | 6439 mm |
| Overall width | 2086 mm |
| Overall height | 2728 mm |
| Wheelbase | 3770 mm |
| Ground clearance | 176 mm |
| Kerb / operating mass | 4110 kg |
| Nominal payload | 1027 kg |
| Passenger capacity | 18 |
| Approx. center-of-gravity height | 1037 mm |
| Nominal turning radius | 7.4 m |
...
| Displacement | 2904 cc |
| Peak power target | 97 kW |
| Peak torque target | 339 Nm |
