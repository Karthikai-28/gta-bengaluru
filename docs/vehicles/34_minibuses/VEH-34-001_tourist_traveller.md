...
| Vehicle ID | `VEH-34-001` |
| Reference name | Tourist Traveller |
...
| Parameter | Target |
|---|---:|
| Overall length | 6409 mm |
| Overall width | 2079 mm |
| Overall height | 2717 mm |
| Wheelbase | 3754 mm |
| Ground clearance | 174 mm |
| Kerb / operating mass | 4065 kg |
| Nominal payload | 1016 kg |
| Passenger capacity | 18 |
| Approx. center-of-gravity height | 1032 mm |
| Nominal turning radius | 7.3 m |
...
| Displacement | 2856 cc |
| Peak power target | 95 kW |
| Peak torque target | 333 Nm |
