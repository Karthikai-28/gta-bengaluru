...
| Category | City Buses |
| Vehicle ID | `VEH-40-007` |
| Reference name | Metro Feeder Bus |
...
| Parameter | Target |
|---|---:|
| Overall length | 12337 mm |
| Overall width | 2601 mm |
| Overall height | 3277 mm |
| Wheelbase | 6145 mm |
| Ground clearance | 223 mm |
| Kerb / operating mass | 13303 kg |
| Nominal payload | 3325 kg |
| Passenger capacity | 55 |
| Approx. center-of-gravity height | 1245 mm |
| Nominal turning radius | 10.9 m |
...
| Displacement | 7674 cc |
| Peak power target | 241 kW |
| Peak torque target | 1316 Nm |
