# VEH-15-001 — Tata Nexon Reference
...
| Category | Compact SUVs and Crossovers |
| Vehicle ID | `VEH-15-001` |
| Reference name | Tata Nexon Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 3976 mm |
| Overall width | 1784 mm |
| Overall height | 1613 mm |
| Wheelbase | 2490 mm |
| Ground clearance | 188 mm |
| Kerb / operating mass | 1236 kg |
...
| Peak power target | 87 kW |
| Peak torque target | 167 Nm |
| Driven wheels / propulsion | FWD |
| Transmission | 6MT/AT/DCT/AMT |
...
| Acceleration rating | 26/100 — Low |
| Braking rating | 70/100 — High |
...
- **Global structural integrity score:** **64/100 (Good)**.
...
- **Architecture:** MacPherson front, torsion beam/multilink rear.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 215/60 R16 |
| Brakes | ABS disc/drum or all-disc |
...
|---|---|
| Whole-vehicle health | 768 HP simulation baseline |
