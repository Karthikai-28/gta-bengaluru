# VEH-49-008 — Heavy Mobile Industrial Crane
...
| Vehicle ID | `VEH-49-008` |
| Reference name | Heavy Mobile Industrial Crane |
...
| Parameter | Target |
|---|---:|
| Overall length | 3146 mm |
| Overall width | 1186 mm |
| Overall height | 2168 mm |
| Wheelbase | 1676 mm |
| Ground clearance | 115 mm |
| Kerb / operating mass | 3366 kg |
| Nominal payload | 841 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 824 mm |
| Nominal turning radius | 2.7 m |
...
| Parameter | Target |
|---|---:|
| Energy source | Diesel/LPG/Battery |
| Displacement | Electric / no engine displacement |
| Peak power target | 33 kW |
| Peak torque target | 236 Nm |
