...
| Vehicle ID | `VEH-49-006` |
| Reference name | Warehouse Cart |
...
| Parameter | Target |
|---|---:|
| Overall length | 3306 mm |
| Overall width | 1228 mm |
| Overall height | 2262 mm |
| Wheelbase | 1748 mm |
| Ground clearance | 129 mm |
| Kerb / operating mass | 3764 kg |
| Nominal payload | 941 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 860 mm |
...
| Peak power target | 39 kW |
| Peak torque target | 278 Nm |
