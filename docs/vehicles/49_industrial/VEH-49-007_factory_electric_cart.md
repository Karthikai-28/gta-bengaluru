# VEH-49-007 — Factory Electric Cart
...
| Category | Industrial and Warehouse Vehicles |
| Vehicle ID | `VEH-49-007` |
| Reference name | Factory Electric Cart |
| Vehicle archetype | Industrial vehicle |
...
| Parameter | Target |
|---|---:|
| Overall length | 3269 mm |
| Overall width | 1219 mm |
| Overall height | 2241 mm |
| Wheelbase | 1732 mm |
| Ground clearance | 126 mm |
| Kerb / operating mass | 3674 kg |
| Nominal payload | 918 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 852 mm |
| Nominal turning radius | 2.9 m |
| Target drag coefficient / equivalent | 0.9 |
...
| Peak power target | 38 kW |
| Peak torque target | 269 Nm |
| Driven wheels / propulsion | front/rear industrial |
| Transmission | hydrostatic/single-speed |
...
| Braking rating | 36/100 — Moderate |
| Mobility score | 20/100 — Low |
| Stability score | 74/100 — High |
| Off-road capability | 20/100 — Low |
...
Heavy welded frame or cast structural chassis with limited cosmetic deformation and high mechanical damage tolerance.
...
- **Architecture:** solid axle / mast or articulated chassis.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | solid pneumatic industrial |
| Brakes | hydraulic / regenerative |
