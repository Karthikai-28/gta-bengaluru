# VEH-08-011 — Honda Gold Wing Reference
...
| Category | Premium Motorcycles and Superbikes |
| Vehicle ID | `VEH-08-011` |
| Reference name | Honda Gold Wing Reference |
...
| Acceleration rating | 90/100 — Very High |
| Braking rating | 95/100 — Extreme |
| Mobility score | 67/100 — High |
| Stability score | 66/100 — High |
| Off-road capability | 2/100 — Very Low |
...
- **Global structural integrity score:** **46/100 (Moderate)**.
...
- **Architecture:** Adjustable USD fork, linkage monoshock.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 120/70-ZR17 / 190/55-ZR17 |
| Brakes | radial multi-piston ABS discs |
...
|---|---|
| Whole-vehicle health | 552 HP simulation baseline |
