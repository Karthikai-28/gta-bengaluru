# VEH-08-019 — Ducati Multistrada Reference
...
| Vehicle ID | `VEH-08-019` |
| Reference name | Ducati Multistrada Reference |
...
| Displacement | 1021 cc |
| Peak power target | 153 kW |
| Peak torque target | 117 Nm |
