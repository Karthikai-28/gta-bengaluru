# VEH-08-016 — Ducati Panigale Reference
...
| Vehicle ID | `VEH-08-016` |
| Reference name | Ducati Panigale Reference |
...
| Peak power target | 154 kW |
| Peak torque target | 118 Nm |
