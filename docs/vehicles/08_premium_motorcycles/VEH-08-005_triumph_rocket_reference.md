# VEH-08-005 — Triumph Rocket Reference
...
| Vehicle ID | `VEH-08-005` |
| Reference name | Triumph Rocket Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 2021 mm |
| Overall width | 737 mm |
| Overall height | 1107 mm |
| Wheelbase | 1401 mm |
| Ground clearance | 123 mm |
| Kerb / operating mass | 320 kg |
| Nominal payload | 180 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 421 mm |
| Nominal turning radius | 2.6 m |
...
| Acceleration rating | 89/100 — Very High |
