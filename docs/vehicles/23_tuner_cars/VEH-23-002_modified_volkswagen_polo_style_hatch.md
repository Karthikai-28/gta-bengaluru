# VEH-23-002 — Modified Volkswagen Polo Style Hatch
...
| Category | Modified and Tuner Cars |
| Vehicle ID | `VEH-23-002` |
| Reference name | Modified Volkswagen Polo Style Hatch |
...
| Overall width | 1854 mm |
| Overall height | 1214 mm |
| Wheelbase | 2573 mm |
| Ground clearance | 83 mm |
| Kerb / operating mass | 1153 kg |
| Nominal payload | 288 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 461 mm |
| Nominal turning radius | 4.8 m |
...
| Parameter | Target |
|---|---:|
| Energy source | Race petrol / hybrid |
| Displacement | 1767 cc |
| Peak power target | 309 kW |
| Peak torque target | 398 Nm |
| Driven wheels / propulsion | RWD/AWD |
| Transmission | sequential/DCT |
...
| Mobility score | 77/100 — High |
| Stability score | 90/100 — Very High |
| Off-road capability | 8/100 — Very Low |
...
- **Architecture:** race coilovers/pushrod, high spring rates.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | slick / semi-slick competition |
| Brakes | race multi-piston ventilated |
