# VEH-23-005 — Modified Skoda Slavia
...
| Vehicle ID | `VEH-23-005` |
| Reference name | Modified Skoda Slavia |
...
| Parameter | Target |
|---|---:|
| Overall length | 4381 mm |
| Overall width | 1864 mm |
| Overall height | 1222 mm |
| Wheelbase | 2590 mm |
| Ground clearance | 85 mm |
| Kerb / operating mass | 1174 kg |
| Nominal payload | 293 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 464 mm |
...
| Displacement | 1819 cc |
| Peak power target | 318 kW |
| Peak torque target | 409 Nm |
