# VEH-23-001 — Modified Maruti Swift
...
| Vehicle ID | `VEH-23-001` |
| Reference name | Modified Maruti Swift |
...
| Overall width | 1892 mm |
| Overall height | 1244 mm |
| Wheelbase | 2636 mm |
| Ground clearance | 89 mm |
| Kerb / operating mass | 1233 kg |
| Nominal payload | 308 kg |
...
| Peak power target | 343 kW |
| Peak torque target | 441 Nm |
...
| Acceleration rating | 87/100 — Very High |
