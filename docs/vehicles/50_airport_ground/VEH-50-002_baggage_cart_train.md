...
| Category | Airport Ground Vehicles |
| Vehicle ID | `VEH-50-002` |
| Reference name | Baggage Cart Train |
...
| Parameter | Target |
|---|---:|
| Overall length | 5831 mm |
| Overall width | 2156 mm |
| Overall height | 2635 mm |
| Wheelbase | 3513 mm |
| Ground clearance | 187 mm |
| Kerb / operating mass | 4678 kg |
| Nominal payload | 1169 kg |
| Passenger capacity | 3 |
| Approx. center-of-gravity height | 1001 mm |
...
| Displacement | 2710 cc |
| Peak power target | 95 kW |
| Peak torque target | 343 Nm |
