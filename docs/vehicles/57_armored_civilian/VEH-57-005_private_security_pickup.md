# VEH-57-005 — Private Security Pickup
...
| Vehicle ID | `VEH-57-005` |
| Reference name | Private Security Pickup |
...
| Parameter | Target |
|---|---:|
| Overall length | 5421 mm |
| Overall width | 1890 mm |
| Overall height | 1845 mm |
| Wheelbase | 3161 mm |
| Ground clearance | 231 mm |
| Kerb / operating mass | 2209 kg |
| Nominal payload | 552 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 701 mm |
...
| Displacement | 2695 cc |
| Peak power target | 140 kW |
| Peak torque target | 431 Nm |
