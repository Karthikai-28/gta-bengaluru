...
| Category | Armored Civilian and VIP Vehicles |
| Vehicle ID | `VEH-57-003` |
| Reference name | Armored Cash Van |
...
| Kerb / operating mass | 1532 kg |
| Nominal payload | 383 kg |
| Passenger capacity | 7 |
| Approx. center-of-gravity height | 737 mm |
...
| Displacement | 1628 cc |
| Peak power target | 81 kW |
| Peak torque target | 217 Nm |
