# VEH-32-023 — Maserati GranTurismo Reference
...
| Vehicle ID | `VEH-32-023` |
| Reference name | Maserati GranTurismo Reference |
...
| Displacement | 3039 cc |
| Peak power target | 355 kW |
| Peak torque target | 507 Nm |
| Driven wheels / propulsion | RWD/AWD |
| Transmission | 7-8DCT/AT |
...
| Braking rating | 96/100 — Extreme |
| Mobility score | 73/100 — High |
| Stability score | 91/100 — Very High |
...
- **Global structural integrity score:** **62/100 (Good)**.
...
- **Architecture:** double wishbone/multilink adaptive.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 245/35 ZR20 / 305/30 ZR20 |
...
|---|---|
| Whole-vehicle health | 744 HP simulation baseline |
