# VEH-32-011 — McLaren Entry Supercar
...
| Vehicle ID | `VEH-32-011` |
| Reference name | McLaren Entry Supercar |
...
| Displacement | 3739 cc |
| Peak power target | 486 kW |
| Peak torque target | 608 Nm |
