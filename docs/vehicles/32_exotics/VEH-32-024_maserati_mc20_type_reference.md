# VEH-32-024 — Maserati MC20 Type Reference
...
| Vehicle ID | `VEH-32-024` |
| Reference name | Maserati MC20 Type Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 4406 mm |
| Overall width | 1935 mm |
| Overall height | 1177 mm |
| Wheelbase | 2588 mm |
| Ground clearance | 97 mm |
| Kerb / operating mass | 1438 kg |
| Nominal payload | 359 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 447 mm |
| Nominal turning radius | 5.3 m |
...
| Displacement | 3566 cc |
| Peak power target | 464 kW |
| Peak torque target | 580 Nm |
...
| Acceleration rating | 91/100 — Very High |
| Braking rating | 98/100 — Extreme |
| Mobility score | 74/100 — High |
| Stability score | 92/100 — Extreme |
