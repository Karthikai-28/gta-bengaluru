# VEH-32-006 — Ferrari Mid Engine Supercar
...
| Vehicle ID | `VEH-32-006` |
| Reference name | Ferrari Mid Engine Supercar |
...
| Parameter | Target |
|---|---:|
| Overall length | 4463 mm |
| Overall width | 1953 mm |
| Overall height | 1190 mm |
| Wheelbase | 2616 mm |
| Ground clearance | 100 mm |
| Kerb / operating mass | 1482 kg |
| Nominal payload | 370 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 452 mm |
...
| Displacement | 3738 cc |
| Peak power target | 486 kW |
| Peak torque target | 607 Nm |
