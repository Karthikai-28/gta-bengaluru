# VEH-32-004 — Lamborghini Urus Type Reference
...
| Vehicle ID | `VEH-32-004` |
| Reference name | Lamborghini Urus Type Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 5154 mm |
| Overall width | 2044 mm |
| Overall height | 1796 mm |
| Wheelbase | 3028 mm |
| Ground clearance | 225 mm |
| Kerb / operating mass | 2515 kg |
| Nominal payload | 628 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 682 mm |
...
| Peak power target | 287 kW |
| Peak torque target | 663 Nm |
