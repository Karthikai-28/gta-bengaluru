# VEH-32-031 — Rolls-Royce Spectre Reference
...
| Vehicle ID | `VEH-32-031` |
| Reference name | Rolls-Royce Spectre Reference |
...
| Overall width | 1986 mm |
| Overall height | 1214 mm |
| Wheelbase | 2669 mm |
| Ground clearance | 106 mm |
| Kerb / operating mass | 1565 kg |
| Nominal payload | 391 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 461 mm |
| Nominal turning radius | 5.5 m |
| Target drag coefficient / equivalent | 0.3 |
...
| Peak power target | 527 kW |
| Peak torque target | 659 Nm |
| Driven wheels / propulsion | RWD/AWD |
| Transmission | 7-8DCT |
...
| Acceleration rating | 92/100 — Extreme |
| Braking rating | 98/100 — Extreme |
| Mobility score | 74/100 — High |
| Stability score | 93/100 — Extreme |
...
- **Global structural integrity score:** **58/100 (Good)**.
...
- **Architecture:** double wishbone pushrod/multilink.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 255/30 ZR20 / 325/30 ZR21 |
| Brakes | carbon-ceramic multi-piston |
...
|---|---|
| Whole-vehicle health | 696 HP simulation baseline |
...
|---|---:|
| Acceleration | 92/100 |
| Top-speed class | 86/100 |
| Braking | 98/100 |
| Handling | 98/100 |
| Stability | 93/100 |
| Mobility | 74/100 |
| Off-road | 0/100 |
| Structural integrity | 58/100 |
