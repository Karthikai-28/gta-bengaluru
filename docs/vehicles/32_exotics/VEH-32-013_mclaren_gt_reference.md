# VEH-32-013 — McLaren GT Reference
...
| Vehicle ID | `VEH-32-013` |
| Reference name | McLaren GT Reference |
...
| Kerb / operating mass | 1558 kg |
| Nominal payload | 389 kg |
...
| Displacement | 4029 cc |
| Peak power target | 524 kW |
| Peak torque target | 655 Nm |
