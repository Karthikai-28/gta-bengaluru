# VEH-32-034 — Pagani Inspired Hypercar
...
| Vehicle ID | `VEH-32-034` |
| Reference name | Pagani Inspired Hypercar |
...
| Parameter | Target |
|---|---:|
| Overall length | 4619 mm |
| Overall width | 1976 mm |
| Overall height | 1143 mm |
| Wheelbase | 2710 mm |
| Ground clearance | 91 mm |
| Kerb / operating mass | 1585 kg |
| Nominal payload | 396 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 434 mm |
...
| Displacement | 4706 cc |
| Peak power target | 800 kW |
| Peak torque target | 941 Nm |
