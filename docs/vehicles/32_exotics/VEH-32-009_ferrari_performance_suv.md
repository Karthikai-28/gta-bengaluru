# VEH-32-009 — Ferrari Performance SUV
...
| Vehicle ID | `VEH-32-009` |
| Reference name | Ferrari Performance SUV |
...
| Displacement | 3634 cc |
| Peak power target | 472 kW |
| Peak torque target | 591 Nm |
