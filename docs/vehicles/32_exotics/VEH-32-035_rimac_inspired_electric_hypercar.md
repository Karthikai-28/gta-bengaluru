# VEH-32-035 — Rimac Inspired Electric Hypercar
...
| Category | Supercars Hypercars and Ultra Luxury |
| Vehicle ID | `VEH-32-035` |
| Reference name | Rimac Inspired Electric Hypercar |
| Vehicle archetype | Performance car |
...
| Parameter | Target |
|---|---:|
| Overall length | 4718 mm |
| Overall width | 2005 mm |
| Overall height | 1164 mm |
| Wheelbase | 2759 mm |
| Ground clearance | 96 mm |
| Kerb / operating mass | 1664 kg |
| Nominal payload | 416 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 442 mm |
| Nominal turning radius | 5.7 m |
| Target drag coefficient / equivalent | 0.26 |

## 5. Powertrain

| Parameter | Target |
|---|---:|
| Energy source | Li-ion battery |
| Displacement | Electric / no engine displacement |
| Peak power target | 861 kW |
| Peak torque target | 1013 Nm |
| Driven wheels / propulsion | AWD |
| Transmission | multi-clutch automated |
| Fuel/battery capacity envelope | 25–120 kWh |
| Driving range envelope | 180–550 km |
...
| Acceleration rating | 96/100 — Extreme |
| Braking rating | 99/100 — Extreme |
| Mobility score | 75/100 — High |
...
Unitized monocoque/body-in-white; front and rear crush structures; detachable closures; deformable suspension and wheel nodes.

### Rigidity target

- **Global structural integrity score:** **60/100 (Good)**.
...
- Cosmetic deformation level: **High**.
...
- **Architecture:** active double wishbone / pushrod.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | bespoke ultra-high-performance |
| Brakes | carbon-ceramic + active aero braking |
...
|---|---|
| Whole-vehicle health | 720 HP simulation baseline |
