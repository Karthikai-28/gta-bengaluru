...
| Vehicle ID | `VEH-26-009` |
| Reference name | BMW M2 Reference |
...
| Kerb / operating mass | 1916 kg |
| Nominal payload | 479 kg |
...
| Displacement | 3038 cc |
| Peak power target | 253 kW |
| Peak torque target | 506 Nm |
