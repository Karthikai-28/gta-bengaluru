...
| Vehicle ID | `VEH-26-013` |
| Reference name | BMW XM Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 5131 mm |
| Overall width | 2038 mm |
| Overall height | 1789 mm |
| Wheelbase | 3016 mm |
| Ground clearance | 223 mm |
| Kerb / operating mass | 2491 kg |
| Nominal payload | 622 kg |
...
| Displacement | 3270 cc |
| Peak power target | 283 kW |
| Peak torque target | 654 Nm |
