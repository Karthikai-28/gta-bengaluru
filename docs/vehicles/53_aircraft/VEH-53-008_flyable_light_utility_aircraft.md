# VEH-53-008 — Flyable Light Utility Aircraft
...
| Category | Aircraft |
| Vehicle ID | `VEH-53-008` |
| Reference name | Flyable Light Utility Aircraft |
...
| Overall width | 11000 mm |
| Overall height | 2900 mm |
| Wheelbase | 0 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 1200 kg |
| Nominal payload | 300 kg |
| Passenger capacity | 4 |
| Approx. center-of-gravity height | 1102 mm |
...
| Mobility score | 67/100 — High |
| Stability score | 99/100 — Extreme |
...
- **Global structural integrity score:** **65/100 (High)**.
...
|---|---|
| Whole-vehicle health | 780 HP simulation baseline |
