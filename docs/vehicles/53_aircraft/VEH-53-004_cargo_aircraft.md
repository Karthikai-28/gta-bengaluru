...
| Category | Aircraft |
| Vehicle ID | `VEH-53-004` |
| Reference name | Cargo Aircraft |
...
| Parameter | Target |
|---|---:|
| Overall length | 70000 mm |
| Overall width | 65000 mm |
| Overall height | 19000 mm |
| Wheelbase | 0 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 220000 kg |
| Nominal payload | 55000 kg |
| Passenger capacity | 4 |
| Approx. center-of-gravity height | 7220 mm |
...
| Braking rating | 42/100 — Moderate |
| Mobility score | 44/100 — Moderate |
...
- **Global structural integrity score:** **92/100 (Extreme)**.
...
|---|---|
| Whole-vehicle health | 1104 HP simulation baseline |
