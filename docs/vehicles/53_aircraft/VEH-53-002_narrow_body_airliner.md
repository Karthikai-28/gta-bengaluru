# VEH-53-002 — Narrow Body Airliner
...
| Category | Aircraft |
| Vehicle ID | `VEH-53-002` |
| Reference name | Narrow Body Airliner |
| Vehicle archetype | Fixed-wing aircraft |
...
| Parameter | Target |
|---|---:|
| Overall length | 39000 mm |
| Overall width | 36000 mm |
| Overall height | 12500 mm |
| Wheelbase | 0 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 47000 kg |
| Nominal payload | 11750 kg |
| Passenger capacity | 180 |
| Approx. center-of-gravity height | 4750 mm |
| Nominal turning radius | 0 m |
| Target drag coefficient / equivalent | 0.0 |

## 5. Powertrain

| Parameter | Target |
|---|---:|
| Energy source | Jet-A1/Avgas |
| Displacement | N/A / turbine or aircraft propulsion class |
| Peak power target | 24000 kW |
| Peak torque target | 0 Nm |
| Driven wheels / propulsion | turboprop/turbofan |
| Transmission | prop reduction / turbine |
| Fuel/battery capacity envelope | Mission dependent |
| Driving range envelope | 300–4,000+ km class dependent |
...
| Reverse speed | System dependent |
| Acceleration rating | 88/100 — Very High |
| Braking rating | 56/100 — Good |
| Mobility score | 52/100 — Good |
| Stability score | 100/100 — Extreme |
| Off-road capability | 0/100 — Very Low |
...
Lightweight aerospace frame with localized structural failure zones; gameplay damage models propulsion, control surfaces/rotors and landing gear.

### Rigidity target

- **Global structural integrity score:** **86/100 (Very High)**.
...
- **Architecture:** oleo-pneumatic landing gear.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | aviation landing gear tyres |
| Brakes | anti-skid wheel brakes + reverse/prop pitch |
...
- **Handling score:** **48/100 (Moderate)**.
...
|---|---|
| Whole-vehicle health | 1032 HP simulation baseline |
| Motor/Engine | torque reduction → rough/limp mode → shutdown |
...
- Capacity: **180 occupant(s)** nominal.
...
|---|---:|
| Acceleration | 88/100 |
| Top-speed class | 100/100 |
| Braking | 56/100 |
| Handling | 48/100 |
| Stability | 100/100 |
| Mobility | 52/100 |
| Off-road | 0/100 |
| Structural integrity | 86/100 |
| Mass/inertia class | Extreme |
