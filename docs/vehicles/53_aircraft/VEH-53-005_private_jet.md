...
| Category | Aircraft |
| Vehicle ID | `VEH-53-005` |
| Reference name | Private Jet |
...
| Overall width | 17000 mm |
| Overall height | 5200 mm |
| Wheelbase | 0 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 7500 kg |
| Nominal payload | 1875 kg |
| Passenger capacity | 10 |
| Approx. center-of-gravity height | 1976 mm |
...
| Braking rating | 76/100 — High |
| Mobility score | 62/100 — Good |
...
- **Global structural integrity score:** **78/100 (High)**.
...
|---|---|
| Whole-vehicle health | 936 HP simulation baseline |
...
- Capacity: **10 occupant(s)** nominal.
...
| Mobility | 62/100 |
| Off-road | 0/100 |
| Structural integrity | 78/100 |
| Mass/inertia class | Moderate |
