...
| Category | Aircraft |
| Vehicle ID | `VEH-53-003` |
| Reference name | Wide Body Airliner |
...
| Parameter | Target |
|---|---:|
| Overall length | 63000 mm |
| Overall width | 60000 mm |
| Overall height | 17500 mm |
| Wheelbase | 0 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 180000 kg |
| Nominal payload | 45000 kg |
| Passenger capacity | 350 |
| Approx. center-of-gravity height | 6650 mm |
...
| Braking rating | 47/100 — Moderate |
| Mobility score | 47/100 — Moderate |
...
- **Global structural integrity score:** **90/100 (Very High)**.
...
- **Handling score:** **38/100 (Moderate)**.
...
|---|---|
| Whole-vehicle health | 1080 HP simulation baseline |
...
- Capacity: **350 occupant(s)** nominal.
