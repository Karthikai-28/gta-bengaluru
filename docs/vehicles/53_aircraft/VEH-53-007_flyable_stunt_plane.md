# VEH-53-007 — Flyable Stunt Plane
...
| Category | Aircraft |
| Vehicle ID | `VEH-53-007` |
| Reference name | Flyable Stunt Plane |
...
| Overall width | 7500 mm |
| Overall height | 2400 mm |
| Wheelbase | 0 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 900 kg |
| Nominal payload | 225 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 912 mm |
...
| Braking rating | 97/100 — Extreme |
| Mobility score | 73/100 — High |
| Stability score | 97/100 — Extreme |
...
- **Global structural integrity score:** **55/100 (Good)**.
...
|---|---|
| Whole-vehicle health | 660 HP simulation baseline |
...
|---|---:|
| Acceleration | 88/100 |
| Top-speed class | 88/100 |
| Braking | 97/100 |
| Handling | 96/100 |
| Stability | 97/100 |
| Mobility | 73/100 |
| Off-road | 0/100 |
| Structural integrity | 55/100 |
