# VEH-30-006 — Lexus Sports Coupe Reference
...
| Category | Lexus Reference Cars |
| Vehicle ID | `VEH-30-006` |
| Reference name | Lexus Sports Coupe Reference |
...
| Displacement | 3017 cc |
| Peak power target | 251 kW |
| Peak torque target | 503 Nm |
