# VEH-42-011 — Campus Electric Shuttle
...
| Vehicle ID | `VEH-42-011` |
| Reference name | Campus Electric Shuttle |
| Vehicle archetype | Minibus / shuttle |
...
| Parameter | Target |
|---|---:|
| Overall length | 6531 mm |
| Overall width | 2107 mm |
| Overall height | 2761 mm |
| Wheelbase | 3815 mm |
| Ground clearance | 182 mm |
| Kerb / operating mass | 4245 kg |
| Nominal payload | 1061 kg |
| Passenger capacity | 18 |
| Approx. center-of-gravity height | 1049 mm |
| Nominal turning radius | 7.6 m |
| Target drag coefficient / equivalent | 0.48 |
...
| Peak power target | 102 kW |
| Peak torque target | 356 Nm |
...
| Braking rating | 44/100 — Moderate |
| Mobility score | 34/100 — Low |
| Stability score | 88/100 — Very High |
| Off-road capability | 15/100 — Very Low |
...
- **Architecture:** heavy independent/leaf or air suspension.
...
- Capacity: **18 occupant(s)** nominal.
