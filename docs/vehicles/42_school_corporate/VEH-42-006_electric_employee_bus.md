# VEH-42-006 — Electric Employee Bus
...
| Category | School and Corporate Transport |
| Vehicle ID | `VEH-42-006` |
| Reference name | Electric Employee Bus |
| Vehicle archetype | Urban bus |
...
| Parameter | Target |
|---|---:|
| Overall length | 12361 mm |
| Overall width | 2605 mm |
| Overall height | 3283 mm |
| Wheelbase | 6155 mm |
| Ground clearance | 224 mm |
| Kerb / operating mass | 13361 kg |
| Nominal payload | 3340 kg |
| Passenger capacity | 55 |
| Approx. center-of-gravity height | 1248 mm |
| Nominal turning radius | 11.0 m |
| Target drag coefficient / equivalent | 0.62 |
...
| Peak power target | 243 kW |
| Peak torque target | 1324 Nm |
| Driven wheels / propulsion | RWD electric/diesel |
| Transmission | AT/AMT/single-speed EV |
...
| Braking rating | 34/100 — Low |
| Mobility score | 24/100 — Low |
| Stability score | 100/100 — Extreme |
| Off-road capability | 5/100 — Very Low |
...
Reinforced monocoque or semi-monocoque body with subframes; progressive crush zones; high cabin survival target.

### Rigidity target

- **Global structural integrity score:** **88/100 (Very High)**.
...
- **Architecture:** air suspension with kneeling capability.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 275/70 R22.5 |
| Brakes | full air disc ABS/EBS |
...
|---|---|
| Whole-vehicle health | 1056 HP simulation baseline |
...
- Capacity: **55 occupant(s)** nominal.
