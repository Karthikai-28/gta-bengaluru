# VEH-13-004 — Tata Tigor Reference
...
| Vehicle ID | `VEH-13-004` |
| Reference name | Tata Tigor Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 4066 mm |
| Overall width | 1767 mm |
| Overall height | 1543 mm |
| Wheelbase | 2518 mm |
| Ground clearance | 172 mm |
| Kerb / operating mass | 1145 kg |
| Nominal payload | 286 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 586 mm |
| Nominal turning radius | 5.0 m |
| Target drag coefficient / equivalent | 0.31 |
...
| Displacement | 1273 cc |
| Peak power target | 72 kW |
| Peak torque target | 122 Nm |
| Driven wheels / propulsion | FWD |
| Transmission | 5MT/AMT/CVT |
...
- **Global structural integrity score:** **56/100 (Good)**.
...
|---|---|
| Whole-vehicle health | 672 HP simulation baseline |
