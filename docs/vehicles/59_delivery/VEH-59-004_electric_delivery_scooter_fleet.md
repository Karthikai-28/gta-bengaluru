# VEH-59-004 — Electric Delivery Scooter Fleet
...
| Vehicle ID | `VEH-59-004` |
| Reference name | Electric Delivery Scooter Fleet |
| Vehicle archetype | Van |
...
| Parameter | Target |
|---|---:|
| Overall length | 4344 mm |
| Overall width | 1734 mm |
| Overall height | 1879 mm |
| Wheelbase | 2720 mm |
| Ground clearance | 175 mm |
| Kerb / operating mass | 1408 kg |
| Nominal payload | 352 kg |
| Passenger capacity | 7 |
| Approx. center-of-gravity height | 714 mm |
| Nominal turning radius | 5.3 m |
| Target drag coefficient / equivalent | 0.38 |
...
| Peak power target | 72 kW |
| Peak torque target | 191 Nm |
| Driven wheels / propulsion | FWD/RWD |
| Transmission | 5-6MT/AT |
...
| Braking rating | 53/100 — Good |
| Mobility score | 44/100 — Moderate |
| Stability score | 82/100 — Very High |
...
- **Global structural integrity score:** **66/100 (High)**.
...
- **Architecture:** MacPherson/double wishbone front, leaf/multilink rear.
...
- **Handling score:** **45/100 (Moderate)**.
...
|---|---|
| Whole-vehicle health | 792 HP simulation baseline |
...
|---|---:|
| Acceleration | 10/100 |
| Top-speed class | 35/100 |
| Braking | 53/100 |
| Handling | 45/100 |
| Stability | 82/100 |
| Mobility | 44/100 |
| Off-road | 20/100 |
| Structural integrity | 66/100 |
