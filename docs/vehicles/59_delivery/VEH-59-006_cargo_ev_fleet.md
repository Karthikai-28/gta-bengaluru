...
| Vehicle ID | `VEH-59-006` |
| Reference name | Cargo EV Fleet |
...
| Parameter | Target |
|---|---:|
| Overall length | 4548 mm |
| Overall width | 1792 mm |
| Overall height | 1955 mm |
| Wheelbase | 2829 mm |
| Ground clearance | 194 mm |
| Kerb / operating mass | 1561 kg |
| Nominal payload | 390 kg |
| Passenger capacity | 7 |
| Approx. center-of-gravity height | 743 mm |
...
| Peak power target | 84 kW |
| Peak torque target | 223 Nm |
