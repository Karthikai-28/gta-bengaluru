# VEH-06-008 — Royal Enfield Continental GT Reference
...
| Category | Retro and Royal Enfield Style Motorcycles |
| Vehicle ID | `VEH-06-008` |
| Reference name | Royal Enfield Continental GT Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 2197 mm |
| Overall width | 799 mm |
| Overall height | 1113 mm |
| Wheelbase | 1419 mm |
| Ground clearance | 179 mm |
| Kerb / operating mass | 200 kg |
| Nominal payload | 180 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 423 mm |
...
| Stability score | 48/100 — Moderate |
...
- **Global structural integrity score:** **50/100 (Good)**.
...
- **Architecture:** Telescopic front, twin-shock/monoshock rear.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 100/90-19 / 120/80-18 |
...
|---|---|
| Whole-vehicle health | 600 HP simulation baseline |
...
|---|---:|
| Acceleration | 21/100 |
| Top-speed class | 32/100 |
| Braking | 73/100 |
| Handling | 68/100 |
| Stability | 48/100 |
| Mobility | 54/100 |
| Off-road | 25/100 |
| Structural integrity | 50/100 |
