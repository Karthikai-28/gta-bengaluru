# VEH-62-002 — Autonomous Delivery Robot
...
| Category | Autonomous and Future Bengaluru Vehicles |
| Vehicle ID | `VEH-62-002` |
| Reference name | Autonomous Delivery Robot |
| Vehicle archetype | Autonomous EV platform |
...
| Parameter | Target |
|---|---:|
| Overall length | 4552 mm |
| Overall width | 1896 mm |
| Overall height | 1647 mm |
| Wheelbase | 2831 mm |
| Ground clearance | 183 mm |
| Kerb / operating mass | 1996 kg |
| Nominal payload | 499 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 626 mm |
| Nominal turning radius | 4.9 m |
| Target drag coefficient / equivalent | 0.24 |

## 5. Powertrain

| Parameter | Target |
|---|---:|
| Energy source | Li-ion solid-state concept |
| Displacement | N/A / non-piston or abstracted propulsion |
| Peak power target | 201 kW |
| Peak torque target | 470 Nm |
| Driven wheels / propulsion | dual-motor AWD |
| Transmission | single-speed |
| Fuel/battery capacity envelope | N/A |
| Driving range envelope | N/A |
...
| Acceleration rating | 65/100 — High |
| Braking rating | 85/100 — Very High |
| Mobility score | 72/100 — High |
| Stability score | 89/100 — Very High |
| Off-road capability | 25/100 — Low |
...
- **Global structural integrity score:** **76/100 (High)**.
...
- **Architecture:** adaptive electronically controlled suspension.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 215/55 R18 low-rolling-resistance |
| Brakes | brake-by-wire + regen |
...
|---|---|
| Whole-vehicle health | 912 HP simulation baseline |
...
|---|---:|
| Acceleration | 65/100 |
| Top-speed class | 54/100 |
| Braking | 85/100 |
| Handling | 82/100 |
| Stability | 89/100 |
| Mobility | 72/100 |
| Off-road | 25/100 |
| Structural integrity | 76/100 |
