...
| Vehicle ID | `VEH-62-004` |
| Reference name | Robot Shuttle |
...
| Parameter | Target |
|---|---:|
| Overall length | 4259 mm |
| Overall width | 1808 mm |
| Overall height | 1556 mm |
| Wheelbase | 2674 mm |
| Ground clearance | 158 mm |
| Kerb / operating mass | 1714 kg |
| Nominal payload | 428 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 591 mm |
| Nominal turning radius | 4.5 m |
...
| Peak power target | 160 kW |
| Peak torque target | 374 Nm |
...
| Acceleration rating | 61/100 — Good |
| Braking rating | 85/100 — Very High |
| Mobility score | 69/100 — High |
