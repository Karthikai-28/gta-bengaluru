...
| Vehicle ID | `VEH-62-001` |
| Reference name | Autonomous Taxi |
...
| Parameter | Target |
|---|---:|
| Overall length | 4451 mm |
| Overall width | 1865 mm |
| Overall height | 1616 mm |
| Wheelbase | 2777 mm |
| Ground clearance | 174 mm |
| Kerb / operating mass | 1899 kg |
| Nominal payload | 474 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 614 mm |
...
| Peak power target | 187 kW |
| Peak torque target | 437 Nm |
...
| Acceleration rating | 64/100 — Good |
| Braking rating | 85/100 — Very High |
| Mobility score | 71/100 — High |
