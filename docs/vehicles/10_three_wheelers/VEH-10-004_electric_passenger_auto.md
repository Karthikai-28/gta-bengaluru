# VEH-10-004 — Electric Passenger Auto
...
| Category | Three Wheelers and Autos |
| Vehicle ID | `VEH-10-004` |
| Reference name | Electric Passenger Auto |
| Vehicle archetype | Three-wheeler |
...
| Parameter | Target |
|---|---:|
| Overall length | 2607 mm |
| Overall width | 1290 mm |
| Overall height | 1694 mm |
| Wheelbase | 1982 mm |
| Ground clearance | 166 mm |
| Kerb / operating mass | 356 kg |
| Nominal payload | 89 kg |
| Passenger capacity | 4 |
| Approx. center-of-gravity height | 644 mm |
| Nominal turning radius | 3.0 m |
| Target drag coefficient / equivalent | 0.4 |
...
| Peak power target | 7 kW |
| Peak torque target | 16 Nm |
| Driven wheels / propulsion | rear wheel |
| Transmission | 4-speed manual / automated |
...
| Mobility score | 34/100 — Low |
| Stability score | 73/100 — High |
| Off-road capability | 18/100 — Very Low |
...
- **Global structural integrity score:** **45/100 (Moderate)**.
...
- **Architecture:** Leading-link/telescopic front with rear coil/leaf arrangement.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 4.00-8 / 4.00-10 |
...
|---|---|
| Whole-vehicle health | 540 HP simulation baseline |
...
|---|---:|
| Acceleration | 15/100 |
| Top-speed class | 17/100 |
| Braking | 53/100 |
| Handling | 45/100 |
| Stability | 73/100 |
| Mobility | 34/100 |
| Off-road | 18/100 |
| Structural integrity | 45/100 |
