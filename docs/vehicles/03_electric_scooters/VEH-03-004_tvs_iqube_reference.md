# VEH-03-004 — TVS iQube Reference
...
| Vehicle ID | `VEH-03-004` |
| Reference name | TVS iQube Reference |
...
| Overall height | 1128 mm |
| Wheelbase | 1254 mm |
| Ground clearance | 153 mm |
| Kerb / operating mass | 106 kg |
| Nominal payload | 180 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 429 mm |
...
| Peak power target | 5 kW |
| Peak torque target | 23 Nm |
