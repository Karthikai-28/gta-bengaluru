# VEH-03-001 — Ather 450 Reference
...
| Vehicle ID | `VEH-03-001` |
| Reference name | Ather 450 Reference |
| Vehicle archetype | Step-through two-wheeler |
...
| Parameter | Target |
|---|---:|
| Overall length | 1913 mm |
| Overall width | 717 mm |
| Overall height | 1194 mm |
| Wheelbase | 1328 mm |
| Ground clearance | 178 mm |
| Kerb / operating mass | 124 kg |
| Nominal payload | 180 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 454 mm |
| Nominal turning radius | 2.1 m |
| Target drag coefficient / equivalent | 0.6 |
...
- **Global structural integrity score:** **36/100 (Moderate)**.
...
- **Architecture:** Telescopic front, twin/single rear shock.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 90/90-12 |
| Brakes | disc/drum with regenerative braking |
...
|---|---|
| Whole-vehicle health | 432 HP simulation baseline |
...
|---|---:|
| Acceleration | 15/100 |
| Top-speed class | 25/100 |
| Braking | 80/100 |
| Handling | 76/100 |
| Stability | 53/100 |
| Mobility | 52/100 |
| Off-road | 15/100 |
| Structural integrity | 36/100 |
