# VEH-51-001 — Namma Metro Passenger Train
...
| Category | Metro and Railway Vehicles |
| Vehicle ID | `VEH-51-001` |
| Reference name | Namma Metro Passenger Train |
| Vehicle archetype | Rail vehicle |
...
| Parameter | Target |
|---|---:|
| Overall length | 22036 mm |
| Overall width | 2903 mm |
| Overall height | 4006 mm |
| Wheelbase | 15021 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 40148 kg |
| Nominal payload | 10037 kg |
| Passenger capacity | 250 |
| Approx. center-of-gravity height | 1522 mm |
| Nominal turning radius | 0 m |
| Target drag coefficient / equivalent | 0.35 |

## 5. Powertrain

| Parameter | Target |
|---|---:|
| Energy source | Overhead/third-rail electricity |
| Displacement | Electric traction / no engine displacement |
| Peak power target | 1508 kW |
| Peak torque target | 8045 Nm |
| Driven wheels / propulsion | electric traction |
| Transmission | traction motor reduction |
| Fuel/battery capacity envelope | Grid supplied |
| Driving range envelope | Route dependent |
...
| Braking rating | 20/100 — Low |
| Mobility score | 15/100 — Very Low |
...
Welded rail carbody/underframe with bogies; gameplay deformation limited to controlled scripted damage.

### Rigidity target

- **Global structural integrity score:** **99/100 (Extreme)**.
...
- Cosmetic deformation level: **Low**.
...
- **Architecture:** air-sprung bogies.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | steel rail wheels |
...
|---|---|
| Whole-vehicle health | 1188 HP simulation baseline |
...
- Capacity: **250 occupant(s)** nominal.
...
|---|---:|
| Acceleration | 15/100 |
| Top-speed class | 22/100 |
| Braking | 20/100 |
| Handling | 5/100 |
| Stability | 100/100 |
| Mobility | 15/100 |
| Off-road | 0/100 |
| Structural integrity | 99/100 |
