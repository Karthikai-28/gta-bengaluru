# VEH-44-006 — Rapid Response Fire Pickup
...
| Vehicle ID | `VEH-44-006` |
| Reference name | Rapid Response Fire Pickup |
...
| Parameter | Target |
|---|---:|
| Overall length | 5451 mm |
| Overall width | 1898 mm |
| Overall height | 1854 mm |
| Wheelbase | 3176 mm |
| Ground clearance | 234 mm |
| Kerb / operating mass | 2237 kg |
| Nominal payload | 559 kg |
...
| Displacement | 2744 cc |
| Peak power target | 143 kW |
| Peak torque target | 439 Nm |
| Driven wheels / propulsion | RWD/4WD |
| Transmission | 6MT/AT |
...
| Braking rating | 59/100 — Good |
| Mobility score | 69/100 — High |
| Stability score | 87/100 — Very High |
| Off-road capability | 80/100 — Very High |
...
- **Global structural integrity score:** **80/100 (Very High)**.
...
- **Architecture:** double wishbone front, leaf/multilink rear.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 265/65 R17 |
| Brakes | disc/drum or all-disc ABS |
...
|---|---|
| Whole-vehicle health | 960 HP simulation baseline |
