# VEH-43-002 — Police Interceptor Motorcycle
...
| Vehicle ID | `VEH-43-002` |
| Reference name | Police Interceptor Motorcycle |
...
- **Global structural integrity score:** **38/100 (Moderate)**.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 80/100-18 / 90/90-18 |
...
|---|---|
| Whole-vehicle health | 456 HP simulation baseline |
