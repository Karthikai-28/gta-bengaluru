# VEH-29-003 — Volvo XC90 Reference
...
| Vehicle ID | `VEH-29-003` |
| Reference name | Volvo XC90 Reference |
...
| Displacement | 2969 cc |
| Peak power target | 257 kW |
| Peak torque target | 594 Nm |
