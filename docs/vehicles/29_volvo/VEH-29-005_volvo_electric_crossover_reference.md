# VEH-29-005 — Volvo Electric Crossover Reference
...
| Category | Volvo Reference Cars |
| Vehicle ID | `VEH-29-005` |
| Reference name | Volvo Electric Crossover Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 4891 mm |
| Overall width | 1969 mm |
| Overall height | 1717 mm |
| Wheelbase | 2895 mm |
| Ground clearance | 200 mm |
| Kerb / operating mass | 2233 kg |
| Nominal payload | 558 kg |
...
| Peak power target | 241 kW |
| Peak torque target | 555 Nm |
...
- **Architecture:** adaptive air/multilink suspension.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 275/45 R21 |
| Brakes | large ventilated discs |
