# VEH-52-007 — Military Style Helicopter
...
| Vehicle ID | `VEH-52-007` |
| Reference name | Military Style Helicopter |
| Vehicle archetype | Rotorcraft |
...
| Parameter | Target |
|---|---:|
| Overall length | 12364 mm |
| Overall width | 2554 mm |
| Overall height | 3591 mm |
| Wheelbase | 0 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 1925 kg |
| Nominal payload | 481 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 1365 mm |
...
| Parameter | Target |
|---|---:|
| Energy source | Jet-A1 |
| Displacement | N/A / turbine or aircraft propulsion class |
| Peak power target | 773 kW |
| Peak torque target | 0 Nm |
| Driven wheels / propulsion | single/twin turbine rotorcraft |
| Transmission | main rotor gearbox |
...
| Braking rating | 85/100 — Very High |
| Mobility score | 92/100 — Extreme |
| Stability score | 77/100 — High |
| Off-road capability | 100/100 — Extreme |
...
- **Global structural integrity score:** **70/100 (High)**.
...
- **Architecture:** rotor/landing gear dynamics.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | skids or retractable wheels |
| Brakes | rotor/collective control |
...
- **Handling score:** **82/100 (Very High)**.
...
|---|---|
| Whole-vehicle health | 840 HP simulation baseline |
...
|---|---:|
| Acceleration | 88/100 |
| Top-speed class | 64/100 |
| Braking | 85/100 |
| Handling | 82/100 |
| Stability | 77/100 |
| Mobility | 92/100 |
| Off-road | 100/100 |
| Structural integrity | 70/100 |
