...
| Vehicle ID | `VEH-52-004` |
| Reference name | Medical Helicopter |
...
| Parameter | Target |
|---|---:|
| Overall length | 11902 mm |
| Overall width | 2485 mm |
| Overall height | 3476 mm |
| Wheelbase | 0 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 1766 kg |
| Nominal payload | 441 kg |
