# VEH-27-008 — Audi S Performance Reference
...
| Vehicle ID | `VEH-27-008` |
| Reference name | Audi S Performance Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 4874 mm |
| Overall width | 1866 mm |
| Overall height | 1419 mm |
| Wheelbase | 2935 mm |
| Ground clearance | 127 mm |
| Kerb / operating mass | 1790 kg |
| Nominal payload | 447 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 539 mm |
...
| Displacement | 2741 cc |
| Peak power target | 228 kW |
| Peak torque target | 457 Nm |
