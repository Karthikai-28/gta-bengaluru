...
| Vehicle ID | `VEH-27-004` |
| Reference name | Audi Q3 Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 5172 mm |
| Overall width | 2049 mm |
| Overall height | 1802 mm |
| Wheelbase | 3037 mm |
| Ground clearance | 227 mm |
| Kerb / operating mass | 2535 kg |
| Nominal payload | 633 kg |
...
| Displacement | 3354 cc |
| Peak power target | 291 kW |
| Peak torque target | 671 Nm |
