# VEH-27-011 — Audi Performance EV Reference
...
| Vehicle ID | `VEH-27-011` |
| Reference name | Audi Performance EV Reference |
...
| Approx. center-of-gravity height | 547 mm |
| Nominal turning radius | 5.7 m |
| Target drag coefficient / equivalent | 0.25 |
...
| Peak torque target | 487 Nm |
| Driven wheels / propulsion | RWD/AWD |
| Transmission | 8-9AT/DCT |
...
- **Architecture:** multi-link adaptive air/coil suspension.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 245/45 R19 |
| Brakes | large ventilated multi-piston discs |
