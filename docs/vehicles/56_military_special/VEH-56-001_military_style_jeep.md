# VEH-56-001 — Military Style Jeep
...
| Vehicle ID | `VEH-56-001` |
| Reference name | Military Style Jeep |
...
| Parameter | Target |
|---|---:|
| Overall length | 5301 mm |
| Overall width | 2129 mm |
| Overall height | 1982 mm |
| Wheelbase | 3152 mm |
| Ground clearance | 240 mm |
| Kerb / operating mass | 4386 kg |
| Nominal payload | 1096 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 753 mm |
| Nominal turning radius | 6.5 m |
...
| Peak power target | 267 kW |
| Peak torque target | 747 Nm |
