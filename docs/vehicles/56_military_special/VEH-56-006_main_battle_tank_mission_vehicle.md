# VEH-56-006 — Main Battle Tank Mission Vehicle
...
| Category | Military and Special Vehicles |
| Vehicle ID | `VEH-56-006` |
| Reference name | Main Battle Tank Mission Vehicle |
...
| Parameter | Target |
|---|---:|
| Overall length | 9500 mm |
| Overall width | 3700 mm |
| Overall height | 2500 mm |
| Wheelbase | 0 mm |
| Ground clearance | 450 mm |
| Kerb / operating mass | 55000 kg |
| Nominal payload | 13750 kg |
| Passenger capacity | 4 |
| Approx. center-of-gravity height | 950 mm |
...
| Peak power target | 1100 kW |
| Peak torque target | 6000 Nm |
| Driven wheels / propulsion | tracked |
| Transmission | heavy automatic transmission |
...
| Braking rating | 25/100 — Low |
| Mobility score | 40/100 — Moderate |
...
- **Global structural integrity score:** **100/100 (Extreme)**.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | tracked running gear |
| Brakes | hydro-mechanical track braking |
...
- **Handling score:** **12/100 (Very Low)**.
...
|---|---|
| Whole-vehicle health | 1200 HP simulation baseline |
