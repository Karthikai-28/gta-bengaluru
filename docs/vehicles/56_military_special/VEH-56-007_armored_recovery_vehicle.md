# VEH-56-007 — Armored Recovery Vehicle
...
| Vehicle ID | `VEH-56-007` |
| Reference name | Armored Recovery Vehicle |
...
| Parameter | Target |
|---|---:|
| Overall length | 5117 mm |
| Overall width | 2076 mm |
| Overall height | 1923 mm |
| Wheelbase | 3058 mm |
| Ground clearance | 222 mm |
| Kerb / operating mass | 4047 kg |
| Nominal payload | 1011 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 731 mm |
...
| Displacement | 3782 cc |
| Peak power target | 236 kW |
| Peak torque target | 662 Nm |
