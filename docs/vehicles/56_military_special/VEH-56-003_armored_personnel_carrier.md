# VEH-56-003 — Armored Personnel Carrier
...
| Vehicle ID | `VEH-56-003` |
| Reference name | Armored Personnel Carrier |
...
| Kerb / operating mass | 22000 kg |
| Nominal payload | 5500 kg |
| Passenger capacity | 10 |
| Approx. center-of-gravity height | 988 mm |
| Nominal turning radius | 8.0 m |
...
| Peak power target | 330 kW |
| Peak torque target | 1500 Nm |
| Driven wheels / propulsion | 8x8 |
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | run-flat military 14.00 R20 |
| Brakes | heavy pneumatic/hydraulic ABS |
