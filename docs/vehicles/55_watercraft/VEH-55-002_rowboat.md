...
| Vehicle ID | `VEH-55-002` |
| Reference name | Rowboat |
| Vehicle archetype | Watercraft |
...
| Kerb / operating mass | 110 kg |
| Nominal payload | 27 kg |
| Passenger capacity | 4 |
| Approx. center-of-gravity height | 266 mm |
...
| Peak power target | 0.4 kW |
| Peak torque target | 6 Nm |
| Driven wheels / propulsion | propeller or waterjet |
| Transmission | marine reduction |
...
| Braking rating | 68/100 — High |
| Mobility score | 54/100 — Good |
...
Marine hull with buoyancy compartments and propulsion module; localized hull damage affects flooding and stability.

### Rigidity target

- **Global structural integrity score:** **32/100 (Low)**.
...
- **Architecture:** hull hydrodynamics.
...
| Brakes | reverse thrust / hydrodynamic drag |
...
|---|---|
| Whole-vehicle health | 384 HP simulation baseline |
...
|---|---:|
| Acceleration | 15/100 |
| Top-speed class | 2/100 |
| Braking | 68/100 |
| Handling | 62/100 |
| Stability | 89/100 |
| Mobility | 54/100 |
| Off-road | 100/100 |
| Structural integrity | 32/100 |
