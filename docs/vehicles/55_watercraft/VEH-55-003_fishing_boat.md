...
| Vehicle ID | `VEH-55-003` |
| Reference name | Fishing Boat |
...
| Parameter | Target |
|---|---:|
| Overall length | 5018 mm |
| Overall width | 2005 mm |
| Overall height | 1605 mm |
| Wheelbase | 0 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 907 kg |
| Nominal payload | 226 kg |
...
| Displacement | 1519 cc |
| Peak power target | 86 kW |
| Peak torque target | 182 Nm |
