...
| Vehicle ID | `VEH-55-004` |
| Reference name | Small Motorboat |
...
| Parameter | Target |
|---|---:|
| Overall length | 4973 mm |
| Overall width | 1992 mm |
| Overall height | 1593 mm |
| Wheelbase | 0 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 889 kg |
| Nominal payload | 222 kg |
...
| Displacement | 1472 cc |
| Peak power target | 83 kW |
| Peak torque target | 177 Nm |
