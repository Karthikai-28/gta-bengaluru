...
| Vehicle ID | `VEH-55-001` |
| Reference name | Pedal Boat |
...
| Kerb / operating mass | 180 kg |
| Nominal payload | 45 kg |
| Passenger capacity | 4 |
| Approx. center-of-gravity height | 418 mm |
...
- **Global structural integrity score:** **35/100 (Moderate)**.
...
|---|---|
| Whole-vehicle health | 420 HP simulation baseline |
