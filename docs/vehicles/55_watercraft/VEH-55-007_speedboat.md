...
| Vehicle ID | `VEH-55-007` |
| Reference name | Speedboat |
...
| Peak torque target | 550 Nm |
| Driven wheels / propulsion | propeller or waterjet |
| Transmission | marine reduction |
| Fuel/battery capacity envelope | 35–65 L |
| Driving range envelope | 450–700 km |
...
| Mobility score | 80/100 — Very High |
