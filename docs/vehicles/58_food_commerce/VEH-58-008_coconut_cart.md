...
| Vehicle ID | `VEH-58-008` |
| Reference name | Coconut Cart |
...
| Parameter | Target |
|---|---:|
| Overall length | 4312 mm |
| Overall width | 1753 mm |
| Overall height | 1854 mm |
| Wheelbase | 2506 mm |
| Ground clearance | 176 mm |
| Kerb / operating mass | 1761 kg |
...
| Displacement | 1009 cc |
| Peak power target | 35 kW |
| Peak torque target | 101 Nm |
