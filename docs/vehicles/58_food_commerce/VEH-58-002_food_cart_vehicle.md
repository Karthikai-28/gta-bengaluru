...
| Vehicle ID | `VEH-58-002` |
| Reference name | Food Cart Vehicle |
...
| Parameter | Target |
|---|---:|
| Overall length | 4169 mm |
| Overall width | 1712 mm |
| Overall height | 1802 mm |
| Wheelbase | 2435 mm |
| Ground clearance | 163 mm |
| Kerb / operating mass | 1628 kg |
...
| Braking rating | 51/100 — Good |
| Mobility score | 39/100 — Moderate |
| Stability score | 83/100 — Very High |
...
- **Architecture:** independent/leaf front and leaf rear.
...
- **Handling score:** **42/100 (Moderate)**.
