# VEH-58-007 — Vegetable Auto Commerce
...
| Category | Food and Street Commerce Vehicles |
| Vehicle ID | `VEH-58-007` |
| Reference name | Vegetable Auto Commerce |
...
| Parameter | Target |
|---|---:|
| Overall length | 2714 mm |
| Overall width | 1328 mm |
| Overall height | 1754 mm |
| Wheelbase | 2051 mm |
| Ground clearance | 182 mm |
| Kerb / operating mass | 390 kg |
| Nominal payload | 97 kg |
| Passenger capacity | 4 |
| Approx. center-of-gravity height | 667 mm |
| Nominal turning radius | 3.1 m |
