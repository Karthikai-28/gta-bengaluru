...
| Vehicle ID | `VEH-60-001` |
| Reference name | Go Kart |
...
| Kerb / operating mass | 165 kg |
| Nominal payload | 41 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 247 mm |
...
| Displacement | 270 cc |
| Peak power target | 9 kW |
| Peak torque target | 18 Nm |
| Driven wheels / propulsion | rear chain drive |
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 5 in competition kart slicks |
