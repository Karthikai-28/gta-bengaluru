...
| Vehicle ID | `VEH-60-004` |
| Reference name | Rally Hatchback |
...
| Parameter | Target |
|---|---:|
| Overall length | 4363 mm |
| Overall width | 1859 mm |
| Overall height | 1217 mm |
| Wheelbase | 2581 mm |
| Ground clearance | 84 mm |
| Kerb / operating mass | 1163 kg |
| Nominal payload | 290 kg |
...
| Displacement | 1792 cc |
| Peak power target | 314 kW |
| Peak torque target | 403 Nm |
