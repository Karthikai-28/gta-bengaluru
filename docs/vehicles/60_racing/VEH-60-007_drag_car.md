...
| Vehicle ID | `VEH-60-007` |
| Reference name | Drag Car |
...
| Parameter | Target |
|---|---:|
| Overall length | 4433 mm |
| Overall width | 1880 mm |
| Overall height | 1234 mm |
| Wheelbase | 2616 mm |
| Ground clearance | 87 mm |
| Kerb / operating mass | 1208 kg |
| Nominal payload | 302 kg |
...
| Displacement | 1899 cc |
| Peak power target | 332 kW |
| Peak torque target | 427 Nm |
