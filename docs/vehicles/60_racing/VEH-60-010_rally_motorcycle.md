...
| Vehicle ID | `VEH-60-010` |
| Reference name | Rally Motorcycle |
...
| Parameter | Target |
|---|---:|
| Overall length | 2253 mm |
| Overall width | 869 mm |
| Overall height | 1386 mm |
| Wheelbase | 1489 mm |
| Ground clearance | 236 mm |
| Kerb / operating mass | 214 kg |
| Nominal payload | 180 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 527 mm |
