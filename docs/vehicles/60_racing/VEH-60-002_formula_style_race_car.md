# VEH-60-002 — Formula Style Race Car
...
| Vehicle ID | `VEH-60-002` |
| Reference name | Formula Style Race Car |
...
| Kerb / operating mass | 1197 kg |
| Nominal payload | 299 kg |
...
| Displacement | 1873 cc |
| Peak power target | 328 kW |
