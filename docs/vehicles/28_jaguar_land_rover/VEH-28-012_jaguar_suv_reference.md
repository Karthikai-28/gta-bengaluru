# VEH-28-012 — Jaguar SUV Reference
...
| Vehicle ID | `VEH-28-012` |
| Reference name | Jaguar SUV Reference |
...
| Kerb / operating mass | 2212 kg |
| Nominal payload | 553 kg |
...
| Peak power target | 237 kW |
| Peak torque target | 547 Nm |
