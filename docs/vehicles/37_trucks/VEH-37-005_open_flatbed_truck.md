...
| Vehicle ID | `VEH-37-005` |
| Reference name | Open Flatbed Truck |
...
| Parameter | Target |
|---|---:|
| Overall length | 8592 mm |
| Overall width | 2519 mm |
| Overall height | 3230 mm |
| Wheelbase | 4844 mm |
| Ground clearance | 256 mm |
| Kerb / operating mass | 9222 kg |
| Nominal payload | 2305 kg |
| Passenger capacity | 3 |
| Approx. center-of-gravity height | 1227 mm |
| Nominal turning radius | 8.6 m |
...
| Displacement | 5185 cc |
| Peak power target | 187 kW |
| Peak torque target | 881 Nm |
