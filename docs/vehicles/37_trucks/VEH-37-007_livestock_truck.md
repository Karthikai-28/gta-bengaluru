...
| Vehicle ID | `VEH-37-007` |
| Reference name | Livestock Truck |
...
| Parameter | Target |
|---|---:|
| Overall length | 8594 mm |
| Overall width | 2520 mm |
| Overall height | 3230 mm |
| Wheelbase | 4845 mm |
| Ground clearance | 256 mm |
| Kerb / operating mass | 9227 kg |
| Nominal payload | 2306 kg |
...
| Displacement | 5189 cc |
| Peak power target | 187 kW |
| Peak torque target | 882 Nm |
