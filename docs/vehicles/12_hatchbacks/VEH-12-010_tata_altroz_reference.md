# VEH-12-010 — Tata Altroz Reference
...
| Category | Everyday Hatchbacks |
| Vehicle ID | `VEH-12-010` |
| Reference name | Tata Altroz Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 3979 mm |
| Overall width | 1737 mm |
| Overall height | 1526 mm |
| Wheelbase | 2514 mm |
| Ground clearance | 164 mm |
| Kerb / operating mass | 1043 kg |
| Nominal payload | 260 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 580 mm |
| Nominal turning radius | 4.8 m |
| Target drag coefficient / equivalent | 0.32 |

## 5. Powertrain

| Parameter | Target |
|---|---:|
| Energy source | Petrol/CNG |
| Displacement | 1189 cc |
| Peak power target | 65 kW |
| Peak torque target | 114 Nm |
| Driven wheels / propulsion | FWD |
| Transmission | 5MT/AMT/CVT/DCT |
...
| Acceleration rating | 19/100 — Very Low |
| Braking rating | 73/100 — High |
| Mobility score | 57/100 — Good |
| Stability score | 85/100 — Very High |
...
- **Architecture:** MacPherson front, torsion beam rear.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 185/65 R15 |
| Brakes | front disc / rear drum or disc ABS |
