# VEH-41-009 — Double Decker Sleeper Coach
...
| Category | Intercity and Coach Buses |
| Vehicle ID | `VEH-41-009` |
| Reference name | Double Decker Sleeper Coach |
| Vehicle archetype | Intercity coach |
...
| Parameter | Target |
|---|---:|
| Overall length | 13944 mm |
| Overall width | 2582 mm |
| Overall height | 3858 mm |
| Wheelbase | 7208 mm |
| Ground clearance | 198 mm |
| Kerb / operating mass | 15611 kg |
| Nominal payload | 3902 kg |
| Passenger capacity | 45 |
| Approx. center-of-gravity height | 1466 mm |
| Nominal turning radius | 11.8 m |
| Target drag coefficient / equivalent | 0.55 |
...
| Displacement | 9550 cc |
| Peak power target | 297 kW |
| Peak torque target | 1592 Nm |
...
| Braking rating | 35/100 — Moderate |
| Mobility score | 27/100 — Low |
| Stability score | 100/100 — Extreme |
| Off-road capability | 3/100 — Very Low |
...
- **Architecture:** electronically controlled air suspension.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 295/80 R22.5 |
| Brakes | air disc EBS + retarder |
...
- Capacity: **45 occupant(s)** nominal.
