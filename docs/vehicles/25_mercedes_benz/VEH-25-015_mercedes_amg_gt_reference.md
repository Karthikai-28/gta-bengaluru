# VEH-25-015 — Mercedes AMG GT Reference
...
| Category | Mercedes-Benz Reference Luxury Fleet |
| Vehicle ID | `VEH-25-015` |
| Reference name | Mercedes AMG GT Reference |
...
| Overall height | 1247 mm |
| Wheelbase | 2435 mm |
| Ground clearance | 107 mm |
| Kerb / operating mass | 1443 kg |
| Nominal payload | 360 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 474 mm |
| Nominal turning radius | 5.1 m |
...
| Displacement | 2689 cc |
| Peak power target | 314 kW |
| Peak torque target | 448 Nm |
