# VEH-25-006 — Mercedes GLA Reference
...
| Vehicle ID | `VEH-25-006` |
| Reference name | Mercedes GLA Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 5063 mm |
| Overall width | 2018 mm |
| Overall height | 1769 mm |
| Wheelbase | 2982 mm |
| Ground clearance | 216 mm |
| Kerb / operating mass | 2418 kg |
| Nominal payload | 604 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 672 mm |
...
| Displacement | 3129 cc |
| Peak power target | 271 kW |
| Peak torque target | 626 Nm |
