# VEH-25-017 — Mercedes EQ SUV Reference
...
| Vehicle ID | `VEH-25-017` |
| Reference name | Mercedes EQ SUV Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 4444 mm |
| Overall width | 1853 mm |
| Overall height | 1667 mm |
| Wheelbase | 2685 mm |
| Ground clearance | 199 mm |
| Kerb / operating mass | 1830 kg |
| Nominal payload | 457 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 633 mm |
...
| Peak power target | 139 kW |
| Peak torque target | 334 Nm |
| Driven wheels / propulsion | FWD/RWD/AWD electric |
...
| Acceleration rating | 49/100 — Moderate |
| Braking rating | 73/100 — High |
| Mobility score | 64/100 — Good |
...
- **Global structural integrity score:** **68/100 (High)**.
...
- **Architecture:** MacPherson/multilink tuned for battery mass.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 215/60 R17 |
| Brakes | four-wheel disc + regen |
...
|---|---|
| Whole-vehicle health | 816 HP simulation baseline |
