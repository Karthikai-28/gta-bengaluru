...
| Vehicle ID | `VEH-36-006` |
| Reference name | Police Pickup |
...
| Parameter | Target |
|---|---:|
| Overall length | 5426 mm |
| Overall width | 1892 mm |
| Overall height | 1847 mm |
| Wheelbase | 3163 mm |
| Ground clearance | 232 mm |
| Kerb / operating mass | 2214 kg |
...
| Displacement | 2704 cc |
| Peak power target | 141 kW |
| Peak torque target | 433 Nm |
