...
| Vehicle ID | `VEH-24-007` |
| Reference name | Rally Raid Vehicle |
...
| Parameter | Target |
|---|---:|
| Overall length | 5262 mm |
| Overall width | 1850 mm |
| Overall height | 1799 mm |
| Wheelbase | 3081 mm |
| Ground clearance | 216 mm |
| Kerb / operating mass | 2065 kg |
| Nominal payload | 516 kg |
