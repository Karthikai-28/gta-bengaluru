...
| Vehicle ID | `VEH-24-006` |
| Reference name | Dune Buggy |
...
| Parameter | Target |
|---|---:|
| Overall length | 5206 mm |
| Overall width | 1837 mm |
| Overall height | 1783 mm |
| Wheelbase | 3053 mm |
| Ground clearance | 211 mm |
| Kerb / operating mass | 2015 kg |
| Nominal payload | 503 kg |
