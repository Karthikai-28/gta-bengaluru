...
| Vehicle ID | `VEH-39-007` |
| Reference name | Mobile Crane Truck |
...
| Parameter | Target |
|---|---:|
| Overall length | 8239 mm |
| Overall width | 2445 mm |
| Overall height | 3116 mm |
| Wheelbase | 4674 mm |
| Ground clearance | 232 mm |
| Kerb / operating mass | 8368 kg |
| Nominal payload | 2092 kg |
...
| Displacement | 4473 cc |
| Peak power target | 161 kW |
| Peak torque target | 760 Nm |
