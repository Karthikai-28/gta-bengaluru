# VEH-39-003 — Concrete Mixer Truck
...
| Vehicle ID | `VEH-39-003` |
| Reference name | Concrete Mixer Truck |
...
| Parameter | Target |
|---|---:|
| Overall length | 12563 mm |
| Overall width | 2559 mm |
| Overall height | 3816 mm |
| Wheelbase | 6528 mm |
| Ground clearance | 283 mm |
| Kerb / operating mass | 18208 kg |
| Nominal payload | 4552 kg |
| Passenger capacity | 3 |
| Approx. center-of-gravity height | 1450 mm |
| Nominal turning radius | 11.1 m |
| Target drag coefficient / equivalent | 0.68 |

## 5. Powertrain

| Parameter | Target |
|---|---:|
| Energy source | Diesel/LNG/EV |
| Displacement | 7121 cc |
| Peak power target | 264 kW |
| Peak torque target | 1322 Nm |
| Driven wheels / propulsion | 6x4 / 8x4 |
| Transmission | 9-16MT/AMT |
...
| Braking rating | 29/100 — Low |
| Mobility score | 30/100 — Low |
...
- **Global structural integrity score:** **96/100 (Extreme)**.
...
| Brakes | air disc/drum ABS + engine brake |
...
- **Handling score:** **16/100 (Very Low)**.
...
|---|---|
| Whole-vehicle health | 1152 HP simulation baseline |
