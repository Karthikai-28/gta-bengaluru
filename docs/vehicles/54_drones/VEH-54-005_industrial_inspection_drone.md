# VEH-54-005 — Industrial Inspection Drone
...
| Category | Drones |
| Vehicle ID | `VEH-54-005` |
| Reference name | Industrial Inspection Drone |
| Vehicle archetype | Uncrewed aerial vehicle |
...
| Parameter | Target |
|---|---:|
| Overall length | 656 mm |
| Overall width | 654 mm |
| Overall height | 222 mm |
| Wheelbase | 0 mm |
| Ground clearance | 0 mm |
| Kerb / operating mass | 2 kg |
| Nominal payload | 0 kg |
| Passenger capacity | 0 |
| Approx. center-of-gravity height | 84 mm |
...
| Parameter | Target |
|---|---:|
| Energy source | LiPo/Li-ion battery |
| Displacement | Electric / no engine displacement |
| Peak power target | 1 kW |
| Peak torque target | 0 Nm |
| Driven wheels / propulsion | electric multi-rotor |
| Transmission | direct drive |
| Fuel/battery capacity envelope | 2–5 kWh |
| Driving range envelope | 80–180 km |
...
- **Global structural integrity score:** **15/100 (Very Low)**.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | none |
| Brakes | motor thrust vectoring |
...
|---|---|
| Whole-vehicle health | 180 HP simulation baseline |
