...
| Category | Taxi and Ride Hailing Fleet |
| Vehicle ID | `VEH-20-004` |
| Reference name | EV Taxi |
| Vehicle archetype | Sedan / saloon |
...
| Parameter | Target |
|---|---:|
| Overall length | 4637 mm |
| Overall width | 1771 mm |
| Overall height | 1491 mm |
| Wheelbase | 2688 mm |
| Ground clearance | 171 mm |
| Kerb / operating mass | 1298 kg |
| Nominal payload | 324 kg |
| Passenger capacity | 5 |
| Approx. center-of-gravity height | 567 mm |
| Nominal turning radius | 5.3 m |
| Target drag coefficient / equivalent | 0.29 |
...
| Peak power target | 95 kW |
| Peak torque target | 153 Nm |
| Driven wheels / propulsion | FWD |
| Transmission | 6MT/CVT/DCT/AT |
...
| Acceleration rating | 33/100 — Low |
| Braking rating | 80/100 — Very High |
| Mobility score | 64/100 — Good |
| Stability score | 87/100 — Very High |
...
- **Architecture:** MacPherson front, torsion/multilink rear.
