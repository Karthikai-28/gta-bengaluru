# VEH-17-001 — Mahindra Scorpio Reference
...
| Category | Large Indian SUVs |
| Vehicle ID | `VEH-17-001` |
| Reference name | Mahindra Scorpio Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 4603 mm |
| Overall width | 1883 mm |
| Overall height | 1761 mm |
| Wheelbase | 2721 mm |
| Ground clearance | 199 mm |
| Kerb / operating mass | 1847 kg |
| Nominal payload | 461 kg |
| Passenger capacity | 7 |
| Approx. center-of-gravity height | 669 mm |
...
| Displacement | 2108 cc |
| Peak power target | 139 kW |
| Peak torque target | 383 Nm |
| Driven wheels / propulsion | RWD/4WD/AWD |
| Transmission | 6MT/6-8AT |
...
- **Architecture:** double wishbone/multilink or heavy independent/solid axle.
