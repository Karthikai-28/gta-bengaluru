# VEH-11-003 — Renault Kwid Reference
...
| Vehicle ID | `VEH-11-003` |
| Reference name | Renault Kwid Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 3006 mm |
| Overall width | 1502 mm |
| Overall height | 1603 mm |
| Wheelbase | 2004 mm |
| Ground clearance | 166 mm |
| Kerb / operating mass | 824 kg |
| Nominal payload | 206 kg |
| Passenger capacity | 4 |
| Approx. center-of-gravity height | 609 mm |
| Nominal turning radius | 4.2 m |
...
| Parameter | Target |
|---|---:|
| Energy source | Petrol or EV |
| Displacement | 806 cc |
| Peak power target | 35 kW |
| Peak torque target | 71 Nm |
