...
| Category | Micro and Tiny Cars |
| Vehicle ID | `VEH-11-005` |
| Reference name | Compact City EV |
| Vehicle archetype | Hatchback / city car |
...
| Parameter | Target |
|---|---:|
| Overall length | 3041 mm |
| Overall width | 1515 mm |
| Overall height | 1619 mm |
| Wheelbase | 2023 mm |
| Ground clearance | 170 mm |
| Kerb / operating mass | 846 kg |
| Nominal payload | 211 kg |
| Passenger capacity | 4 |
| Approx. center-of-gravity height | 615 mm |
| Nominal turning radius | 4.3 m |
...
| Peak power target | 37 kW |
| Peak torque target | 73 Nm |
| Driven wheels / propulsion | FWD or rear e-drive |
| Transmission | 5MT/AMT/single-speed EV |
...
| Acceleration rating | 10/100 — Very Low |
| Braking rating | 66/100 — High |
| Mobility score | 46/100 — Moderate |
| Stability score | 80/100 — Very High |
| Off-road capability | 10/100 — Very Low |
...
- **Global structural integrity score:** **48/100 (Moderate)**.
...
- **Architecture:** MacPherson strut front, torsion/semi-independent rear.
...
|---|---|
| Whole-vehicle health | 576 HP simulation baseline |
...
|---|---:|
| Acceleration | 10/100 |
| Top-speed class | 31/100 |
| Braking | 66/100 |
| Handling | 60/100 |
| Stability | 80/100 |
| Mobility | 46/100 |
| Off-road | 10/100 |
| Structural integrity | 48/100 |
