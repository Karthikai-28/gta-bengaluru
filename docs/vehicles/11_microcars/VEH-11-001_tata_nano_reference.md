# VEH-11-001 — Tata Nano Reference
...
| Vehicle ID | `VEH-11-001` |
| Reference name | Tata Nano Reference |
...
| Kerb / operating mass | 700 kg |
| Nominal payload | 175 kg |
| Passenger capacity | 4 |
| Approx. center-of-gravity height | 628 mm |
