# VEH-48-006 — Tractor with Farm Implement
...
| Vehicle ID | `VEH-48-006` |
| Reference name | Tractor with Farm Implement |
| Vehicle archetype | Agricultural vehicle |
...
| Parameter | Target |
|---|---:|
| Overall length | 3578 mm |
| Overall width | 1806 mm |
| Overall height | 2235 mm |
| Wheelbase | 2041 mm |
| Ground clearance | 351 mm |
| Kerb / operating mass | 2034 kg |
| Nominal payload | 508 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 849 mm |
| Nominal turning radius | 3.3 m |
...
| Displacement | 2661 cc |
| Peak power target | 31 kW |
| Peak torque target | 142 Nm |
| Driven wheels / propulsion | 2WD/4WD |
| Transmission | 8F+2R / 12F+12R |
...
| Braking rating | 30/100 — Low |
| Mobility score | 37/100 — Moderate |
| Stability score | 81/100 — Very High |
| Off-road capability | 97/100 — Extreme |
...
- **Architecture:** oscillating front axle / agricultural tyres.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 6.00-16 / 13.6-28 agricultural |
...
- **Handling score:** **18/100 (Very Low)**.
