...
| Vehicle ID | `VEH-47-010` |
| Reference name | Mobile Crane |
...
| Parameter | Target |
|---|---:|
| Overall length | 6707 mm |
| Overall width | 2454 mm |
| Overall height | 3082 mm |
| Wheelbase | 3595 mm |
| Ground clearance | 343 mm |
| Kerb / operating mass | 9117 kg |
| Nominal payload | 2279 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 1171 mm |
| Nominal turning radius | 6.8 m |
...
| Displacement | 4990 cc |
| Peak power target | 122 kW |
| Peak torque target | 554 Nm |
