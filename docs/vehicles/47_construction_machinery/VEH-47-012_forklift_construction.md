# VEH-47-012 — Forklift Construction
...
| Vehicle ID | `VEH-47-012` |
| Reference name | Forklift Construction |
| Vehicle archetype | Construction machinery |
...
| Parameter | Target |
|---|---:|
| Overall length | 6557 mm |
| Overall width | 2415 mm |
| Overall height | 3022 mm |
| Wheelbase | 3526 mm |
| Ground clearance | 326 mm |
| Kerb / operating mass | 8669 kg |
| Nominal payload | 2167 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 1148 mm |
| Nominal turning radius | 6.6 m |
...
| Displacement | 4634 cc |
| Peak power target | 113 kW |
| Peak torque target | 515 Nm |
| Driven wheels / propulsion | 4WD hydro-mechanical |
| Transmission | powershift/hydrostatic |
...
| Braking rating | 32/100 — Low |
| Mobility score | 39/100 — Moderate |
| Stability score | 100/100 — Extreme |
| Off-road capability | 95/100 — Extreme |
...
- **Global structural integrity score:** **98/100 (Extreme)**.
...
- **Architecture:** hydraulic articulation / heavy axles.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | industrial / 16.9-28 class |
| Brakes | industrial wet disc/hydraulic |
...
|---|---|
| Whole-vehicle health | 1176 HP simulation baseline |
...
|---|---:|
| Acceleration | 15/100 |
| Top-speed class | 12/100 |
| Braking | 32/100 |
| Handling | 20/100 |
| Stability | 100/100 |
| Mobility | 39/100 |
| Off-road | 95/100 |
| Structural integrity | 98/100 |
