...
| Vehicle ID | `VEH-47-002` |
| Reference name | Excavator |
...
| Parameter | Target |
|---|---:|
| Overall length | 5045 mm |
| Overall width | 2013 mm |
| Overall height | 1763 mm |
| Wheelbase | 2973 mm |
| Ground clearance | 214 mm |
| Kerb / operating mass | 2398 kg |
| Nominal payload | 599 kg |
...
| Displacement | 3092 cc |
| Peak power target | 268 kW |
| Peak torque target | 618 Nm |
