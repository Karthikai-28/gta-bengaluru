...
| Vehicle ID | `VEH-47-011` |
| Reference name | Crawler Crane |
...
| Parameter | Target |
|---|---:|
| Overall length | 6623 mm |
| Overall width | 2432 mm |
| Overall height | 3049 mm |
| Wheelbase | 3557 mm |
| Ground clearance | 334 mm |
| Kerb / operating mass | 8867 kg |
| Nominal payload | 2216 kg |
| Passenger capacity | 1 |
| Approx. center-of-gravity height | 1159 mm |
| Nominal turning radius | 6.7 m |
...
| Displacement | 4792 cc |
| Peak power target | 117 kW |
| Peak torque target | 532 Nm |
