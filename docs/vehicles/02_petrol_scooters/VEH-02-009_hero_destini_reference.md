# VEH-02-009 — Hero Destini Reference
...
| Category | Petrol Scooters |
| Vehicle ID | `VEH-02-009` |
| Reference name | Hero Destini Reference |
...
| Overall width | 682 mm |
| Overall height | 1143 mm |
| Wheelbase | 1257 mm |
| Ground clearance | 154 mm |
| Kerb / operating mass | 105 kg |
...
| Braking rating | 78/100 — High |
| Mobility score | 48/100 — Moderate |
| Stability score | 52/100 — Good |
...
- **Global structural integrity score:** **34/100 (Low)**.
...
- **Architecture:** Telescopic front, single rear shock.
...
| Parameter | Target |
|---|---|
| Wheel/tyre package | 90/90-12 / 90/100-10 |
| Brakes | front disc or drum / rear drum |
...
|---|---|
| Whole-vehicle health | 408 HP simulation baseline |
