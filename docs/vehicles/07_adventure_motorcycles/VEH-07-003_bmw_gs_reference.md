...
| Vehicle ID | `VEH-07-003` |
| Reference name | BMW GS Reference |
...
| Parameter | Target |
|---|---:|
| Overall length | 2247 mm |
| Overall width | 867 mm |
| Overall height | 1383 mm |
| Wheelbase | 1485 mm |
| Ground clearance | 234 mm |
| Kerb / operating mass | 213 kg |
| Nominal payload | 180 kg |
| Passenger capacity | 2 |
| Approx. center-of-gravity height | 526 mm |
